      ...
      <NavigationBar></NavigationBar>
        <Container>
            ...
            <Row>
                <Col lg={4}>
                <h3> Mission</h3>
                <p>At Track Me , our mission is to empower individuals to lead healthier and more active lives by providing accessible and personalized fitness solutions. We believe that everyone deserves the opportunity to achieve their wellness goals, regardless of their fitness level or lifestyle.</p>
                </Col>
                <Col lg={4}>
                <h3> Vision</h3>
                <p>Our vision is to create a global community where fitness is enjoyable, inclusive, and sustainable. We aspire to be the go-to platform that inspires and supports individuals on their fitness journey, fostering a positive impact on their overall well-being.</p>
                </Col>
                <Col lg={4}>
                <h3>Our History</h3>
                <p>Track Me was founded in 2023 by VAZ Foundation with a passion for making fitness accessible to everyone. Recognizing the challenges people face in maintaining a consistent exercise routine, we set out to create an app that combines cutting-edge technology with user-friendly design to simplify the path to a healthier lifestyle.</p>
